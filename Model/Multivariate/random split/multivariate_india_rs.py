# -*- coding: utf-8 -*-
"""Multivariate_India_RS

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1cSpgUeHJgdZHdKbfZMJ7-o7wxWQE47aj
"""
...
scaler_filename = "/content/drive/My Drive/covid project/Data/scalars/Totals_moving"
...
future_predict_df = pd.read_csv('/content/drive/My Drive/covid project/Data/Processed_Data/moving_avg/test_Totals.csv',index_col = 0)
...
def MODEL_LSTM(x_train,x_test,y_train,y_test,Num_Exp,Epochs,Hidden,batch_size,n_steps_in,n_steps_out):
    ...
    for run in range(Num_Exp):
        ...
        for step in range (1,16):
          chain_inp = np.concatenate([chain_inp.reshape(chain_inp.shape[0],chain_inp.shape[1],n_features)[:,-2:,:],ty_test.reshape(chain_out.shape[0],chain_out.shape[1],n_features)],axis=1)
          chain_out = model.predict(chain_inp)
          print(chain_out.shape)
          for pred in chain_out[0]:
            results.append(pred)
        future_prediction[run][:] = results
...
def Plot(name,labels,width,LSTM,Bi_LSTM,EN_DC,yer1,yer2,yer3,xlabel,ylabel,Gname,cap):
    ...
    ax.legend()
    fig.tight_layout()
    plt.savefig("/content/drive/My Drive/covid project/Model/Results/Multivariate/NEW_RESULTS_TESTING/All India/"+name+"_"+Gname+".png",dpi=300)
    plt.show()

### TRAINING DATASET ###
df0 = pd.read_csv('/content/drive/My Drive/covid project/Data/Processed_Data/random_shuffle/train_Delhi.csv')
df1 = pd.read_csv('/content/drive/My Drive/covid project/Data/Processed_Data/random_shuffle/train_Gujarat.csv')
df2 = pd.read_csv('/content/drive/My Drive/covid project/Data/Processed_Data/random_shuffle/train_Haryana.csv')
df3 = pd.read_csv('/content/drive/My Drive/covid project/Data/Processed_Data/random_shuffle/train_Karnataka.csv')
df4 = pd.read_csv('/content/drive/My Drive/covid project/Data/Processed_Data/random_shuffle/train_Madhya Pradesh.csv')
df5 = pd.read_csv('/content/drive/My Drive/covid project/Data/Processed_Data/random_shuffle/train_Maharashtra.csv')
df6 = pd.read_csv('/content/drive/My Drive/covid project/Data/Processed_Data/random_shuffle/train_Rajasthan.csv')
df7 = pd.read_csv('/content/drive/My Drive/covid project/Data/Processed_Data/random_shuffle/train_Tamil Nadu.csv')
df8 = pd.read_csv('/content/drive/My Drive/covid project/Data/Processed_Data/random_shuffle/train_Uttar Pradesh.csv')
df9 = pd.read_csv('/content/drive/My Drive/covid project/Data/Processed_Data/random_shuffle/train_West Bengal.csv')
dft = pd.read_csv('/content/drive/My Drive/covid project/Data/Processed_Data/random_shuffle/train_Totals.csv')
dfr = pd.read_csv('/content/drive/My Drive/covid project/Data/Processed_Data/random_shuffle/train_Rest of India.csv')

### TESTING DATASET ###

df00 = pd.read_csv('/content/drive/My Drive/covid project/Data/Processed_Data/random_shuffle/test_Delhi.csv')
df10 = pd.read_csv('/content/drive/My Drive/covid project/Data/Processed_Data/random_shuffle/test_Gujarat.csv')
df20 = pd.read_csv('/content/drive/My Drive/covid project/Data/Processed_Data/random_shuffle/test_Haryana.csv')
df30 = pd.read_csv('/content/drive/My Drive/covid project/Data/Processed_Data/random_shuffle/test_Karnataka.csv')
df40 = pd.read_csv('/content/drive/My Drive/covid project/Data/Processed_Data/random_shuffle/test_Madhya Pradesh.csv')
df50 = pd.read_csv('/content/drive/My Drive/covid project/Data/Processed_Data/random_shuffle/test_Maharashtra.csv')
df60 = pd.read_csv('/content/drive/My Drive/covid project/Data/Processed_Data/random_shuffle/test_Rajasthan.csv')
df70 = pd.read_csv('/content/drive/My Drive/covid project/Data/Processed_Data/random_shuffle/test_Tamil Nadu.csv')
df80 = pd.read_csv('/content/drive/My Drive/covid project/Data/Processed_Data/random_shuffle/test_Uttar Pradesh.csv')
df90 = pd.read_csv('/content/drive/My Drive/covid project/Data/Processed_Data/random_shuffle/test_West Bengal.csv')
dft0 = pd.read_csv('/content/drive/My Drive/covid project/Data/Processed_Data/random_shuffle/test_Totals.csv')
dfr0 = pd.read_csv('/content/drive/My Drive/covid project/Data/Processed_Data/random_shuffle/test_Rest of India.csv')
...
x_test = np.array(df.tail(1).iloc[0,0:6])
y_test = np.array(df.tail(1).iloc[0,6:10])

tx_test = []
tx_test.append(x_test)

ty_test = []
ty_test.append(y_test)

y_test[-2:]

tx_test =np.asarray(tx_test, dtype=np.float32)
ty_test = np.asarray(ty_test, dtype=np.float32)

final = np.concatenate([tx_test.reshape(tx_test.shape[0],tx_test.shape[1],1)[:,-2:,:],ty_test.reshape(ty_test.shape[0],ty_test.shape[1],1)],axis=1)

# np.reshape(1,len(final))
# np.array(list(final))
final
