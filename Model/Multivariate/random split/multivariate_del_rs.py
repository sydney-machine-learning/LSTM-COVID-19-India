...
Original file is located at
    https://colab.research.google.com/drive/1AKqLhv5t-4cR_9Qf14R2bCTxiQZIJb1x
"""
...
def Plot(name,labels,width,LSTM,Bi_LSTM,EN_DC,yer1,yer2,yer3,xlabel,ylabel,Gname,cap):
    ...
    ax.legend()
    fig.tight_layout()
    plt.savefig("/content/drive/My Drive/covid project/Model/Results/Multivariate/NEW_RESULTS_TESTING/Delhi/"+name+"_"+Gname+".png",dpi=300)
    plt.show()
