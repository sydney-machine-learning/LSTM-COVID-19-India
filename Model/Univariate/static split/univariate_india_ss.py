...
Original file is located at
    https://colab.research.google.com/drive/1XKC-YNRRBZszlWn0efBdvc-40b0F-BYw
"""
...
for i in range(1,2):
    problem=i
    if problem ==1:
        TrainData = pd.read_csv('/content/drive/My Drive/covid project/Data/Processed_Data/moving_avg/train_Totals.csv',index_col = 0)
        TrainData = TrainData.values
        TestData = pd.read_csv('/content/drive/My Drive/covid project/Data/Processed_Data/moving_avg/test_Totals.csv',index_col = 0)
